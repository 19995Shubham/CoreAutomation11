...
public class BackForwardFirmOrderStepDefinition extends BaseTest_Core
{
    ...
    public void navigate_to_vehicle_order_page() throws InterruptedException {
        ...
        Assert.assertTrue(vop.validateDealerOrderPageLoad(), "Dealer Order details page loaded");
    }
    ...
    public void navigate_to_forward_orders_entry_page()
    {
        ...
        Assert.assertTrue(fop.validateLoadForwardOrderPageLoad(filePathForScreenshot),
                "Dealer Order details page loaded");
        fop.resetPageSize();
    }
    ...
    public void navigateToFinalizeForwardOrderSOP() throws InterruptedException {
        ...
        Assert.assertTrue(ffop.validateFinalizeForwardOrderSOPPageLoad(filePathForScreenshot),
                "Finalise Forward Order SOP %");
    }
